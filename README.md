...
The C#/.NET 9 + Avalonia port now has a **prebuilt release**: **[Extreme Launcher .NET port — 5.1.5](https://github.com/mrtitanic777/ExtremeLauncher/releases/latest)** — **ATLauncher and Technic modpack browsers** you can search and install from, bringing the in-app modpack platforms to four (Modrinth, CurseForge, ATLauncher, Technic), on top of 5.1.4's CurseForge browser and folder resource-pack import.

Self-contained builds — no .NET runtime to install, just download, unzip and run:

| Platform | Download |
|----------|----------|
| Windows (x64) | [`…-win-x64.zip`](https://github.com/mrtitanic777/ExtremeLauncher/releases/latest/download/ExtremeLauncher-dotnet-5.1.5-win-x64.zip) |
| Linux (x64) | [`…-linux-x64.zip`](https://github.com/mrtitanic777/ExtremeLauncher/releases/latest/download/ExtremeLauncher-dotnet-5.1.5-linux-x64.zip) |
| macOS (Apple Silicon) | [`…-osx-arm64.zip`](https://github.com/mrtitanic777/ExtremeLauncher/releases/latest/download/ExtremeLauncher-dotnet-5.1.5-osx-arm64.zip) |
| macOS (Intel) | [`…-osx-x64.zip`](https://github.com/mrtitanic777/ExtremeLauncher/releases/latest/download/ExtremeLauncher-dotnet-5.1.5-osx-x64.zip) |
